...
とりあえずFP1,2のフリー走行でしっかりセッティングを煮詰めないと、
...
ペレス、ボッタス、角田までは上手く雨のタイミングをずらせてタイムが出せたみたい。
...
B. Interスタートの場合、
最初の1,2周はいい感じ。そこから6周目までが乾いてきて、Interで走れない場合はピット入ってDryにして、
...
現実のレッドブルには、ハンナ・シュミッツがいるから戦略外すことほとんどないなのにね。
...
ちょうどInterも十分使って、ピットインでWetかInterかに変更になるかな。
...
確かに、またすぐに路面が1.00mmを超えてきてInter路面だから、
...
一時停止できなかったら判断できずに終わっていたなー。本当にゲームで良かった。
